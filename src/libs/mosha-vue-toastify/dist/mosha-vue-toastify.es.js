...
var M, E;
((E = M || (M = {}))[(E.TITLE_ONLY = 0)] = "TITLE_ONLY"),
  (E[(E.TITLE_DESCRIPTION = 1)] = "TITLE_DESCRIPTION"),
...
const z = {
  ...
  O = (e, t, o) => {
    const n = u(),
      s = u(void 0),
      i = u(),
      r = (e) => e instanceof MouseEvent,
      p = (u) => {
        !1 !== o &&
          n.value &&
          (r(u)
            ? (s.value = n.value.clientX - u.clientX)
            : (s.value = n.value.touches[0].clientX - u.touches[0].clientX),
          (i.value = a(l({}, i.value), { transition: "none" })),
          e.endsWith("left")
            ? (i.value.left = -s.value + "px !important")
            : e.endsWith("right")
            ? (i.value.right = `${s.value}px !important`)
            : s.value > 0
            ? (i.value.left = -s.value + "px !important")
            : (i.value.right = `${s.value}px !important`),
          Math.abs(s.value) > 200 && t());
      },
      h = (e) => {
        !1 !== o &&
          (n.value && (n.value = void 0),
          s.value && (s.value = void 0),
          removeEventListener(e, p));
      };
    return (
      c(() => {
      ...
      }),
      {
        ...
        startSwipeHandler: (t) => {
          if (!1 === o) return;
          n.value = t;
          const a = r(t) ? "mousemove" : "touchmove",
            u = r(t) ? "mouseup" : "touchend";
          addEventListener(a, p),
            addEventListener(u, () =>
              ((t) => {
                const o = { transition: "left .3s ease-out", left: 0 },
                  r = { transition: "right .3s ease-out", right: 0 },
                  a = { transition: "all .3s ease-out", left: 0, right: 0 };
                e.endsWith("left")
                  ? (i.value = l(l({}, i.value), o))
                  : e.endsWith("right")
                  ? (i.value = l(l({}, i.value), r))
                  : (i.value = l(l({}, i.value), a)),
                  (n.value = void 0),
                  (s.value = void 0),
...
var Y = v({
  ...
  setup(e, t) {
    const o = u(),
      { width: n } = (() => {
        const e = u(-1),
          ...
          o = (o) => {
            null !== o &&
              null !== o.currentTarget &&
              ((e.value = o.currentTarget.innerWidth),
              (t.value = o.currentTarget.innerHeight));
          };
        return (
          p(() => {
            window.innerWidth > 0 &&
              ((e.value = window.innerWidth), (t.value = window.innerHeight)),
              window.addEventListener("resize", L(o));
          }),
          c(() => {
      ...
      })(),
      {
        ...
        swipeStyle: r,
        cleanUpMove: l,
      } = O(e.position, e.onCloseHandler, e.swipeClose),
      { transitionType: a } =
        ((d = e.position),
        (v = e.transition),
        (m = s),
    ...
    const {
          ...
          }),
          {
            start: () => {
              (n.value = Date.now()),
                ...
                (o.value = setTimeout(e, s.value));
            },
            stop: () => {
              clearInterval(i.value),
                clearTimeout(o.value),
                (s.value -= Date.now() - n.value);
            },
            clear: l,
            progress: r,
          }
      ...
      y = h(() => t.slots.default),
      b = h(() => /<\/?[a-z][\s\S]*>/i.test(e.description)),
      I = () => {
        e.timeout > 0 && f();
      };
    return (
      g(() => {
        const { customStyle: t } = ((e, t, o) => {
          ...
          return (
            o.length > 0 && (n.value.backgroundColor = o), { customStyle: n }
          );
...
const A = { class: "mosha__toast__content-wrapper" },
  G = { class: "mosha__toast__content" },
  J = { class: "mosha__toast__content__text" },
  K = { key: 1, class: "mosha__toast__content__description" },
            ...
            ? (m(),
              f(
                "div",
                {
                  ...
                  onMouseenter:
                    t[2] ||
                    (t[2] = (...t) => e.onMouseEnter && e.onMouseEnter(...t)),
                  onMouseleave:
                    t[3] ||
                    (t[3] = (...t) => e.onMouseLeave && e.onMouseLeave(...t)),
                  onTouchstartPassive:
                    t[4] ||
                    (t[4] = (...t) => e.onTouchStart && e.onTouchStart(...t)),
                  onMousedown:
                    t[5] ||
                    (t[5] = (...t) => e.onMouseDown && e.onMouseDown(...t)),
                },
                [
                  d("div", A, [
                    e.showIcon
                      ? (m(), f(r, { key: 0, type: e.type }, null, 8, ["type"]))
                      : b("", !0),
                    d("div", G, [
                      d("div", J, I(e.text), 1),
                      e.description.length > 0 && e.isDescriptionHtml
                        ...
                        : b("", !0),
                      e.description.length > 0 && !e.isDescriptionHtml
                        ? (m(), f("div", K, I(e.description), 1))
                        : b("", !0),
                    ]),
                  ]),
                  e.isSlotPassed
                    ? (m(), f("div", Q, [T(e.$slots, "default")]))
                    : b("", !0),
                  e.showCloseButton
                    ? (m(),
                      f("div", {
...
const te = (e, t) => {
    const o = ee++,
      n = t ? se(t) : C;
    if (e.__v_isVNode)
      return oe(o, M.VNODE, n, e), { close: () => le(o, n.position) };
    if (e.hasOwnProperty("render"))
      return oe(o, M.COMPONENT, n, e), { close: () => le(o, n.position) };
    const s = ie(e);
    ...
    setTimeout(() => {
      ...
      document.body.appendChild(i),
        (r =
          t === M.VNODE
            ? d(Y, ne(o, e, s, le), () => [n])
            : t === M.TITLE_DESCRIPTION
            ? d(Y, ne(o, e, s, le, n))
            : d(Y, ne(o, e, s, le), () => [d(n)])),
        x(r, i),
        Z[o.position].push({ toastVNode: r, container: i }),
  ...
  le = (e, t) => {
    const o = Z[t],
      n = o.findIndex(({ toastVNode: t }) => t.props && e === t.props.id);
    if (-1 === n) return;
    ...
    Z[t].splice(n, 1),
      ((e, t, o, n) => {
        for (let s = e; s < t.length; s++) {
          ...
          if (!e.el) return;
          const i = o.split("-")[0] || "top",
            r = parseInt(e.el.style[i], 10) - n - 12;
          if (!e.component) return;
          e.component.props.offset = r;
        }
      })(n, o, t, r),
      i.component &&
        ((i.component.props.visible = !1),
        i.component.props.onClose && i.component.props.onClose(),
        setTimeout(() => {
